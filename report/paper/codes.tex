...
\begin{table*}[htbp]
    ...
    \toprule
    \multirow{2}{*}{\textbf{Model Variant}} & \multirow{2}{*}{\textbf{Metric}} & \multicolumn{3}{c}{\textbf{Forecast Horizon}} \\
    \cmidrule(l){3-5}
    & & \textbf{3-day} & \textbf{5-day} & \textbf{10-day} \\
    \midrule
    \multirow{4}{*}{\makecell[l]{Full Model\\(MAGAT-FN)}} 
    & RMSE & 992.85 & 1080.51 & 1427.51 \\
    & PCC & 0.890 & 0.885 & 0.750 \\
    & R² & 0.766 & 0.723 & 0.516 \\
    \midrule
    \multirow{4}{*}{\makecell[l]{Without AGAM\\(No Adaptive Graph\\Attention)}} 
    & RMSE & 1092.21 (+10.01\%) & 1145.35 (+6.00\%) & 1429.04 (+0.11\%) \\
    & PCC & 0.848 (-4.62\%) & 0.861 (-2.70\%) & 0.794 (+5.75\%) \\
    & R² & 0.717 (-6.42\%) & 0.688 (-4.74\%) & 0.515 (-0.20\%) \\
    \midrule
    \multirow{4}{*}{\makecell[l]{Without MTFM\\(No Multi-scale\\Fusion)}} 
    & RMSE & 1010.39 (+1.77\%) & 1132.70 (+4.83\%) & 1290.55 (-9.59\%) \\
    & PCC & 0.881 (-0.98\%) & 0.855 (-3.33\%) & 0.811 (+8.04\%) \\
    & R² & 0.758 (-1.09\%) & 0.695 (-3.80\%) & 0.604 (+17.13\%) \\
    \midrule
    \multirow{4}{*}{\makecell[l]{Without PPRM\\(No Progressive\\Prediction)}} 
...
\begin{figure}[htbp]
    \centering
    \subfloat[RMSE comparison across model variants]{\includegraphics[width=0.48\columnwidth]{../../figures/ablation_compare_RMSE_japan.w-20.h-5.png}\label{fig:ablation_rmse}}
    \hfill
    \subfloat[MAE comparison across model variants]{\includegraphics[width=0.48\columnwidth]{../../figures/ablation_compare_MAE_japan.w-20.h-5.png}\label{fig:ablation_mae}}
...
\begin{figure}[htbp]
    \centering
    \subfloat[PCC comparison across model variants]{\includegraphics[width=0.48\columnwidth]{../../figures/ablation_compare_PCC_japan.w-20.h-5.png}\label{fig:ablation_pcc}}
    \hfill
    \subfloat[R² comparison across model variants]{\includegraphics[width=0.48\columnwidth]{../../figures/ablation_compare_R2_japan.w-20.h-5.png}\label{fig:ablation_r2}}
...
\begin{figure*}[htbp]
    \centering
    \subfloat[3-day forecast horizon]{\includegraphics[width=0.48\textwidth]{../../figures/ablation_heatmap_japan.w-20.h-3.png}}
    \hfill
    \subfloat[5-day forecast horizon]{\includegraphics[width=0.48\textwidth]{../../figures/ablation_heatmap_japan.w-20.h-5.png}}
    \hfill
    \subfloat[10-day forecast horizon]{\includegraphics[width=0.48\textwidth]{../../figures/ablation_heatmap_japan.w-20.h-10.png}}
