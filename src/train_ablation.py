...
try:
    ...
    from ablation import MAGATFN_Ablation
    print("Successfully imported MAGAT_FN and ablation modules")
    ...
    try:
        ...
        from src.MAGAT_FN import MAGATFN
        from src.ablation import MAGATFN_Ablation
...
parser.add_argument('--ablation', type=str, default='none', 
                   ...
                   help='Ablation study type: none, no_agam, no_mtfm, no_pprm')
...
if args.ablation != 'none':
    ...
    model = MAGATFN_Ablation(args, data_loader)
else:
